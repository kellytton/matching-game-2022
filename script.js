...
function createCards(parentElement, shuffledImageClasses) {
  ...
  for (let i = 0; i < 12; i++) {
    let cardCreated = appendNewCard(parentElement);
    cardCreated.classList.add(shuffledImageClasses[i]);
...
/* LevelUp - Custom Game Theme breakdown:
- made changes to images (background, card flip and unflipped)
- added a restart button to restart/replay the game
- changed the sounds for cards flipped, matches, and win
- changed the font and colors of the text
- changed the color of the glow for matches
- added a footer for copyright */
